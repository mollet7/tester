<?php  // include server config  file
...
require_once "script/checkuserlogin.php";  
?>
                           ...
                           <table class="table table-bordered table-striped">
                            ...
                            <?php  while($row = mysqli_fetch_array($result)){ ?>
                                   <tr>
                                        ...
                                        <td>
                                            <a href="read.php?id=<? echo $row['id']; ?>" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
